...
public class OrdersHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
	...
	public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
		...
		String query = "SELECT count(DISTINCT (ORDERNUMBER)) FROM ADMIN.\"sales_data_sample\"";		
		try {
	...
	public int runQuery(Connection connection, String query) {
		...
		try {
			...
			rs.next();
			result = rs.getInt("COUNT(DISTINCT(ORDERNUMBER))");
